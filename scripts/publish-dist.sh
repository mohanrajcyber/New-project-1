...
mkdir -p "$ROOT/dist/aarch64/core" "$ROOT/dist/aarch64/net" "$ROOT/dist/aarch64/lab"
...
cat > "$ROOT/dist/aarch64/manifest.json" <<EOF
{
  ...
  "version": "${VER}",
  "arch": "aarch64",
  "variants": ["core", "net", "lab"],
  "kernel": "vmlinuz",
  "termux": "scripts/termux-boot-aahaos.sh"
}
EOF
echo "published $ROOT/dist/aarch64"
ls -lh "$ROOT/dist/aarch64" "$ROOT/dist/aarch64/core" "$ROOT/dist/aarch64/net" "$ROOT/dist/aarch64/lab"
